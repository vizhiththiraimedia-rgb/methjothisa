      ...
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-500 mb-8">
          ...
          <span className="font-semibold text-[#1a365d]">
            {language === 'si' ? "සේවා නියමයන්" : "Terms of Service"}
          </span>
        </div>
        ...
        <Card className="shadow-xl shadow-slate-200/50 border-slate-100 rounded-[2rem] overflow-hidden bg-white">
          <CardContent className="p-8 md:p-12">
            <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed text-[16px] whitespace-pre-wrap">
              {language === 'si' ? "අපගේ වෙබ් අඩවිය සහ සේවාවන් භාවිතා කිරීමේදී අදාළ වන නීති සහ රෙගුලාසි මෙහි අන්තර්ගත වේ. කරුණාකර සේවාවන් ලබා ගැනීමට පෙර මේවා කියවා තේරුම් ගන්න." : "The rules and regulations applicable when using our website and services are included here. Please read and understand these before obtaining services."}
            </div>
