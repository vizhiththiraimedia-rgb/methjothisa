      ...
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-500 mb-8 justify-center">
          ...
          <span className="font-semibold text-[#1a365d]">
            {language === 'si' ? "සෞඛ්‍ය පලාඵල" : "Health Horoscope"}
          </span>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            {language === 'si' 
              ...
              : "Astrological insights for your physical and mental well-being."}
          </p>
        ...
        <Card className="shadow-xl shadow-slate-200/50 border-slate-100 rounded-[2rem] overflow-hidden bg-white">
          <div className="bg-[#1a365d] p-6 text-center">
            ...
            <p className="text-indigo-200 text-sm">
              {language === 'si' ? "අද දවසේ පලාඵල කියවීම සඳහා පහතින් ලග්නය තෝරන්න" : "Choose your zodiac sign to read your health horoscope"}
            </p>
          </div>
