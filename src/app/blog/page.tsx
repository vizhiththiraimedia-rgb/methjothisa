        ...
        <Card className="shadow-xl shadow-slate-200/50 border-slate-100 rounded-[2rem] overflow-hidden bg-white">
          <CardContent className="p-8 md:p-12">
            <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed text-[16px] whitespace-pre-wrap">
              {language === 'si' ? "ජ්‍යෝතිෂය, වාස්තු විද්‍යාව සහ ග්‍රහ බලපෑම් පිළිබඳ අපගේ නවතම ලිපි මෙතනින් කියවන්න. මෙම පිටුව ඉතා ඉක්මනින් යාවත්කාලීන වනු ඇත." : "Read our latest articles on astrology, vastu, and planetary influences here. This page will be updated very soon."}
            </div>
