            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span>Moon Sign: <strong>{chartData.moonSign}</strong></span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <Sun className="h-4 w-4 text-indigo-600" />
                  <span>Sun Sign: <strong>{chartData.sunSign}</strong></span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <Sparkles className="h-4 w-4 text-pink-600" />
                  <span>Ascendant: <strong>{chartData.ascendant}</strong></span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <Calendar className="h-4 w-4 text-blue-600" />
                  <span>Nakshatra: <strong>{chartData.nakshatra}</strong></span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <MapPin className="h-4 w-4 text-green-600" />
                  <span>Pada: <strong>{chartData.pada}</strong></span>
                </div>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent className="space-y-3">
                <Button variant="cosmic" className="w-full" onClick={handleExportPDF} isLoading={isExporting}>Export PDF</Button>
                <Button variant="outline" className="w-full" onClick={handleShare}>Share Chart</Button>
